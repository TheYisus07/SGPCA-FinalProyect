...
public class ControllerModifyMinute implements Initializable {
    ...
    public void validFieldsToMeeting() {
        textFieldDescriptionAgreement.getValidators().add(TEXT_FIELD_VALIDATION.getSTRING_LENGTH_VALIDATOR_DESCRIPTION());
        ...
        textFieldManagerAgreement.getValidators().add(TEXT_FIELD_VALIDATION.getSTRING_LENGTH_VALIDATOR_TITLE());
        ...
        textFieldDateAgreement.getValidators().add(TEXT_FIELD_VALIDATION.getSTRING_LENGTH_VALIDATOR_TITLE());
        ...
        textAreaNote.getValidators().add(TEXT_FIELD_VALIDATION.getSTRING_LENGTH_VALIDATOR_DESCRIPTION());
        ...
        textAreaPending.getValidators().add(TEXT_FIELD_VALIDATION.getSTRING_LENGTH_VALIDATOR_DESCRIPTION());
    ...
    public void closeWindow(ActionEvent event) {
        try {
            ...
            Logger.getLogger(ControllerModifyMinute.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
