...
public class ControllerAddNewEvidence implements Initializable {
    ...
    public int addArticle() {
        ...
        if (textFieldAddArticlePublicationDate.validate()){
            ...
            if (actualDate.after(articleRegistrationDate)) {
                article.setPublicationDate(articleRegistrationDate); 
                validDate = true;
            } else {
                textFieldAddArticlePublicationDate.setValue(null);
                textFieldAddArticlePublicationDate.validate();
            }
        }
        ...
        if ((articleAuthor != null) && (articleRegistrationDate != null) && (megazineName != null) && (articleAuthorEmail != null) && (isEndPageNumber) && (isVolumenNumber) && (articleCountry != null) && (articleIssn != null) && validDate) {
            if (addEvidence() == 1) {
                try {
    ...
    public int addChapterBook() {
        ...
        boolean chapterBookBeforeNow = validPublicationYear();
        ...
        if (textFieldAddChapterYear.validate() && chapterBookBeforeNow) {
            try {
                chapterBookYear = Integer.parseInt(textFieldAddChapterYear.getText().trim());
            ...
            textFieldAddChapterYear.setText("");
            textFieldAddChapterYear.validate();
        }
    ...
    public int addBook() {
        ...
        boolean bookBeforeNow = validPublicationBookYear();
        boolean validDate = false;
        ...
        if (textFieldAddBookYear.validate() && bookBeforeNow) {
            try {
                bookPublicationYear = Integer.parseInt(textFieldAddBookYear.getText().trim());
        ...
        if (dataPickerAddBookEndDate.validate() && dataPickerAddBookStartDate.validate()) {
            ...
            if (bookStarDate.before(bookEndDate)) {
                book.setEndDate(bookEndDate);
                book.setStartDate(bookStarDate);
                validDate = true;
            } else {
                dataPickerAddBookEndDate.setValue(null);
                dataPickerAddBookStartDate.setValue(null);
                dataPickerAddBookEndDate.validate();
                dataPickerAddBookStartDate.validate();
            }
        }
        
        if ((bookEditorial != null) && (isYearNumber) && (isEditionNumber) && (bookEndDate != null) && (bookStarDate != null) && validDate) {
            if (addEvidence() == 1) {
                try {
                    int idEvidence = EVIDENCE_DAO.getLastInsertEvidenceId();
    ...
    public int addReceptionalWork() {
        ...
        if (dataPickerReceptionWorkStartDate.validate() && dataPickerAddReceptionWorkFinalDate.validate()) {
            ...
            if (receptionWorkStartDate.before(receptionWorkFinalDate)) {
                receptionWork.setStartDate(receptionWorkStartDate);
                receptionWork.setFinalDate(receptionWorkFinalDate);
                validDate = true;
            } else {
                dataPickerReceptionWorkStartDate.setValue(null);
                dataPickerAddReceptionWorkFinalDate.setValue(null);
                dataPickerReceptionWorkStartDate.validate();
                dataPickerAddReceptionWorkFinalDate.validate();
            }
        }
        ...
        if ((receptionWorkDirection != null) && (receptionWorkFinalDate != null) && (receptionWorkStartDate != null) && (receptionWorkGrade != null) && (isNumberStudents) && (receptionWorkBlueprint != null) && (receptionWorkKind != null) && validDate) {
            if (addEvidence() == 1) {
                try {
                    int idEvidence = EVIDENCE_DAO.getLastInsertEvidenceId();
