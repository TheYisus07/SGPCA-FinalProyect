...
public class ControllerModifyEvent implements Initializable {
    ...
    public void upDateEventOnAction(ActionEvent event) {
        try{
            ...
            String textcomboBoxResponsable = comboBoxResponsable.getSelectionModel().getSelectedItem();
            String textcomboBoxType = comboBoxType.getSelectionModel().getSelectedItem();
            String textcomboBoxPrivacy = comboBoxPrivacy.getSelectionModel().getSelectedItem();
    ...
    public boolean searchEventTitleDuplicated(String title, String titleOfTheOldEvent) {
        ...
        if (!title.equals(titleOfTheOldEvent) && title.equals(EVENT_DAO.consultEvent(title).getTittle())) {
            titleValid = false;
        } else if (title.equals(titleOfTheOldEvent) && title.equals(EVENT_DAO.consultEvent(title).getTittle())) {
            titleValid = true;
        } else if (title.equals(titleOfTheOldEvent) && !title.equals(EVENT_DAO.consultEvent(title).getTittle())) {
            titleValid = true;
        } else if (!title.equals(titleOfTheOldEvent) && !title.equals(EVENT_DAO.consultEvent(title).getTittle())) {
