...
public class ControllerScheduleMeeting implements Initializable {
    ...
    public void validFieldsToMeeting() {
        textFieldMeetingAffair.getValidators().add(TEXT_FIELD_VALIDATION.getSTRING_LENGTH_VALIDATOR_DESCRIPTION());
        ...
        textFieldMeetingPlace.getValidators().add(TEXT_FIELD_VALIDATION.getSTRING_LENGTH_VALIDATOR_TITLE());
        ...
        textFieldResponsable.getValidators().add(TEXT_FIELD_VALIDATION.getSTRING_LENGTH_VALIDATOR_TITLE());
        ...
        textFieldPointToDiscuss.getValidators().add(TEXT_FIELD_VALIDATION.getSTRING_LENGTH_VALIDATOR_DESCRIPTION());
    ...
    public boolean addMeeting() {
        ...
        Date actualDate;
        if (datePickerMeetingDate.validate()) {
